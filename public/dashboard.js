        ...
        $(id).click( function() {
           ...
           if($(id).is(':checked')){
               cbs.each(function() {
                 ...
                 id.setAttribute('class', 'fa fa-check-square');
               });
           }
           else{
            cbs.each(function() {
              ...
              id.removeAttribute('class');
              id.setAttribute('class', 'fa fa-square-o');
          });
         }
      });
      console.log($(id).attr('checked'));
...
function createWineView() {
  ...
  $.get('/product-models', function(data) {
    ...
    for (var field in wine) {
      ...
      if (k != 'id') {
        ...
        if (k == 'casesize') {
          ...
          //myForm.appendChild(dataDiv);
        }
        else if (k == 'exclusive' || k == 'dualstate' || k == 'domestic' || k == 'seasonal') {
          // var input = document.createElement('input');
          // input.setAttribute('type', 'hidden');
          // input.setAttribute('name', k);
          // input.setAttribute('value' ($(('#iclass' + k)).val()));
          //input.setAttribute('class', 'form-control');
        //  input.setAttribute('id', 'wine' + k);
          //input.setAttribute('onclick', 'boxDisable($(this))');
          //input.setAttribute('value', '&#xf14a;');

          var iclass = document.createElement('i');
          iclass.setAttribute('class', 'fa fa-square-o');
          iclass.setAttribute('aria-hidden', 'true');
          iclass.setAttribute('onclick', 'boxDisable($(this))');
    ...
    lastDiv.appendChild(wineButton);
