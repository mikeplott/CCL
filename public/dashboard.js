...
function createBeer(event) {
    ...
    var caseW = f.find('[name=caseWeight]').val();
    var quantity = f.find('[name=quantity]').val();
    // var exclu = f.find('[name=isExclusive]').val();
    // var dualS = f.find('[name=isDualState]').val();
    // var theDomes = f.find('[name=domes]').value;
    // var theSeasons = f.find('name=seasons').value;
    var exclu;
    var dualS;
    var theDomes;
    var theSeasons;
    ...
    console.log(exclu);
    console.log(theDomes);
    console.log(dualS);

    //console.log(document.getElementById("parent29").checked = true);
    // var dom = false;
    // var sea = false;
    // if (document.getElementById('theDom').checked = true) {
    //     dom = true;
    // }
    // if (document.getElementById('theSea').checked = true) {
    //     dom = true;
    // }
    // var isDomestic = f.find('[name=isDomestic]').val();
    // var isSeasonal = f.find('[name=isSeasonal]').val();
